...
素材的選取方式會依**用手指繪圖**設定而改變。關閉時，點一下照片或 PDF 即可選取；開啟時，長按素材，再從選單選擇**移動與調整大小**。用手指繪圖保持開啟時，也能移動或調整已選素材的大小。雙指縮放操作會縮放筆記本身；在手指繪圖模式中，請用已選素材的大小調整控點改變素材大小。Apple Pencil 仍可在資料上書寫。分享時選擇 **其他 → PDF 匯出**，匯出目前筆記或整個科目。背景可設為紙色或白色。
...
簡單備份的更新與還原需 Premium。這是 iCloud 檔案儲存、讀取，不是筆記自動同步。從檔案還原時選擇 zip，完成後依提示關閉並重開 App。語言、左手操作及科目名稱也能在設定修改。
