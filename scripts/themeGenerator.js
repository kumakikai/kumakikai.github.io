...
function determinePaths() {
  // Adapted for an existing Hugo site: project overrides stay outside the vendor.
  const projectRoot = path.join(__dirname, "../");
  return {
    themePath: path.join(projectRoot, "data/theme.json"),
    outputPath: path.join(projectRoot, "assets/css/generated-theme.css"),
  };
}
