...
3. **Founder**：氏名、肩書き、開発領域、短い紹介、補足の技術経験。
...
- **人物イラスト**：homepage、関連kumakikaiリポジトリ、適切なローカル範囲を確認しましたが、独立した元素材とWeb利用権の根拠は見つかりませんでした。名刺全体の転載・切り抜き・AI人物生成は行わず、文字だけのFounderビジュアルにしています。
