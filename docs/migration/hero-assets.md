...
現在のオトミル／ギガポケは [2026-09-07の更新記録](../screenshot-refresh-20260907/README.md) と [素材manifest](../screenshot-refresh-20260907/assets.json) を参照。以下は2026-09-06時点の旧素材記録。Uni:Noteは引き続き以下の原本を使用する。
